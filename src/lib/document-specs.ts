...
const baseSpecs: DocSpec[] = [
  ...
  },
  {
    ...
    groups: [
      {
        id: "pessoal",
        label: "Dados Pessoais & Contactos",
        fields: [
          { id: "full_name", label: "Nome completo", type: "text", required: true },
          { id: "headline", label: "Cargo / área pretendida", type: "text", placeholder: "Ex.: Analista Financeiro / Desenvolvedor Software" },
          { id: "photo_url", label: "Fotografia de Perfil", type: "photo", help: "Opcional. Foto profissional com fundo neutro." },
          { id: "email", label: "Email", type: "text", placeholder: "exemplo@email.com" },
          ...
          { id: "linkedin", label: "LinkedIn / Portefólio", type: "text", placeholder: "linkedin.com/in/seuperfil" },
        ],
      },
      {
        id: "conteudo",
        label: "Percurso Profissional & Académico",
        fields: [
          { id: "profile", label: "Perfil profissional", type: "textarea", help: "Resumo executivo de 2 a 4 linhas sobre as suas qualificações." },
          { id: "experience", label: "Experiência profissional", type: "list", help: "Cargo — Empresa — Período (Ex.: Analista de Finanças — Banco X — 2021–2024)" },
          { id: "education", label: "Formação académica", type: "list", help: "Curso — Instituição — Ano (Ex.: Licenciatura em Gestão — UEM — 2020)" },
          { id: "skills", label: "Competências chave", type: "list", help: "Uma competência por linha" },
    ...
    instructionsPlaceholder:
      "Ex.: destacar experiência executiva, focar em resultados mensuráveis.",
  },
  {
    id: "linkedin_profile",
    ...
    groups: [
      {
        ...
        fields: [
          { id: "full_name", label: "Nome completo", type: "text", required: true },
          { id: "headline", label: "Headline (máx. 220 caracteres)", type: "text", help: "Ex.: Especialista em Finanças | Transformação Digital | Ex-Banco X" },
          { id: "location", label: "Localização", type: "text", placeholder: "Ex.: Maputo, Moçambique" },
          { id: "about", label: "Sobre (About)", type: "textarea", help: "Narrativa executiva em 1.ª pessoa, 2–3 parágrafos." },
          { id: "experience", label: "Experiência profissional", type: "list", help: "Cargo — Empresa — Período (Ex.: Gestor de Projetos — Empresa Y — 2022-2025)" },
          { id: "education", label: "Formação académica", type: "list", help: "Curso — Instituição — Ano" },
          { id: "skills", label: "Competências (Skills)", type: "list", help: "Palavras-chave de setor (ex.: Gestão de Projetos, Liderança)" },
    ...
    instructionsPlaceholder: "Ex.: tom executivo, palavras-chave para ATS/recrutadores, foco em resultados.",
  },
  {
    id: "cover_letter",
    ...
    groups: [
      {
        id: "candidatura",
        label: "Dados da Candidatura",
        fields: [
          { id: "full_name", label: "O seu nome completo", type: "text", required: true },
          { id: "position", label: "Vaga a que se candidata", type: "text", required: true, placeholder: "Ex.: Diretor Financeiro / Engenheiro de Software" },
          { id: "company", label: "Empresa / Instituição", type: "text" },
          { id: "recipient", label: "Destinatário", type: "text", placeholder: "Ex.: Direção de Recursos Humanos" },
          { id: "city", label: "Local", type: "text" },
          { id: "letter_date", label: "Data", type: "date" },
          { id: "purpose", label: "Texto da Carta / Motivação", type: "textarea", required: true, placeholder: "Apresentação, competências relevantes e motivos da candidatura..." },
        ],
      },
    ],
    structure: [
    ...
    instructionsPlaceholder: "Ex.: tom confiante mas formal, no máximo uma página.",
  },
  {
    id: "reference_letter",
    ...
    groups: [
      ...
      },
      {
        ...
        fields: [
          { id: "closing_statement", label: "Texto da Recomendação", type: "textarea", required: true, placeholder: "Recomendo sem reservas o(a) candidato(a)..." },
        ],
      },
    ],
    structure: [
    ...
    instructionsPlaceholder: "Ex.: tom formal mas caloroso, exemplos concretos de desempenho.",
  },
  {
    id: "request",
    label: "Requerimento",
